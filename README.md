...
```
Poderá adicionar também à base de dados o conteúdos dos ficheiros .json presentes na pasta Data relativos aos cursos e ao administrador com o comando "mongoimport".</br></br>
