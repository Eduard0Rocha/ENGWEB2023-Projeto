...
router.get("/", function(req,res) {
    ...
    axios.get("http://api_gfich:3000/api/users", {
        ...
        .then(r => {
            ...
            axios.get("http://api_gfich:3000/api/users/all", {
                headers: {
                    authorization: "Bearer " + jwtToken
                }
            })
            .then(r2 => {
                ...
                axios.get("http://api_gfich:3000/api/files/all", {
                    headers: {
                        authorization: "Bearer " + jwtToken
                    }
                })
...
router.get("/deleteUser", function(req,res) {
    ...
    .then(r => {
        ...
        axios.delete("http://api_gfich:3000/api/users/" + req.query.username, {
            headers: {
                authorization: "Bearer " + jwtToken
            }
        })
...
router.get("/deleteRecurso", function(req,res) {
    ...
    .then(r => {
        ...
        axios.delete("http://api_gfich:3000/api/files/" + req.query.idRecurso, {
            headers: {
                authorization: "Bearer " + jwtToken
            }
        })
